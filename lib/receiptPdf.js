...
function renderReceiptPdf(receipt) {
  return new Promise((resolve, reject) => {
    const doc = new PDFDocument({ size: [300, 440], margin: 24 });
    const chunks = [];
    ...
    // service") - set from a selected catalog item at checkout, or typed
    // manually. Optional - older/custom-amount transactions won't have one.
